...
/**
 * Accepts a Google Cloud Storage change event. 
 * The new object will be submitted to the Google Cloud Vision API for analysis. 
 * Results are then written to the originating bucket as <ORIGINAL_FILE>.annotations.json
 */
exports.processImage = (event, callback) => {
     ...
     * In practice, it would be better to write our results to another bucket
     */
     ...
     * We're checking for general labels here for simplicity.
     */
